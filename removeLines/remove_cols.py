...
def remove_table_lines(imgPath, newImgPath, remove_horizontal=True, remove_vertical=True):
    ...
    if remove_vertical:
        ...
        (v_rows, v_cols) = np.where(horizontal < 50)
...
def read_file(root_path):
    imglist = list(filter(lambda fn: fn.lower().endswith('.jpg') or fn.lower().endswith('.png'),
                          os.listdir(os.path.join(root_path, "img"))))
    for idx in range(len(imglist)):
        imgfn = imglist[idx]
        oldfn = os.path.join(root_path, "img", imgfn)
        newfn = os.path.join(root_path, "remove_v_img", imgfn)
        #print("oldfn:", oldfn)
        #print("newfn:", newfn)
        remove_table_lines(oldfn, newfn, False, True)
        print(idx, "/", len(imglist))


if __name__ == "__main__":
    root_path = "/Users/Shared/D/2020fall_study/thinklab/code/newGFTE/SciTSR/train"
    read_file(root_path)
    root_path = "/Users/Shared/D/2020fall_study/thinklab/code/newGFTE/SciTSR/test"
    read_file(root_path)
'''
    image_Path = "/Users/Shared/D/2020fall_study/thinklab/code/newGFTE/try/img/0704.3878v1.1.png"
    newImgPath = "/Users/Shared/D/2020fall_study/thinklab/code/newGFTE/try/new_img/0704.3878v1.1.png"
    remove_table_lines(image_Path, newImgPath, False, True)
'''
